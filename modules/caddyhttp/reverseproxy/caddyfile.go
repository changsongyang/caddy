...
func (h *Handler) UnmarshalCaddyfile(d *caddyfile.Dispenser) error {
	...
	for d.NextBlock(0) {
		...
		case "header_up":
			...
			// empty string, for pointer usage
			empty := ""

			switch len(args) {
			case 1:
				err = headers.CaddyfileHeaderOp(h.Headers.Request, args[0], "", &empty)
			case 2:
				...
				err = headers.CaddyfileHeaderOp(h.Headers.Request, args[0], args[1], &empty)
			case 3:
		...
		case "header_down":
			...
			switch len(args) {
			case 1:
				err = headers.CaddyfileHeaderOp(h.Headers.Response.HeaderOps, args[0], "", &empty)
			case 2:
				err = headers.CaddyfileHeaderOp(h.Headers.Response.HeaderOps, args[0], args[1], &empty)
			case 3:
